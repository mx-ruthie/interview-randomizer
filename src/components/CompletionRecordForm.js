    ...
    return(
        <div>
            <form className="completed" >
                ...
                <input type="radio" name="complete-status" value={true} checked={completeStatus === true} onChange={(e) => {setCompleteStatus(true); console.log(completeStatus)}}/> Completed Correctly
                <input type="radio"  name="complete-status" value={false} checked={completeStatus === false} onChange={(e) => setCompleteStatus(false)}/> Did Not Complete Correctly
